...
void
write_data( const char * const filename, const data_t * const data ) {
...
data_t
gen_data( point_t * const start_point, const double r_start, const double r_end,
